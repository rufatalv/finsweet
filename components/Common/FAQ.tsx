...
const FAQ = () => {
  return (
    <div className="bg-white">
      <div className="container flex px-4 min-[1310px]:px-0 flex-col gap-12 lg:gap-0 lg:flex-row justify-between py-12 md:py-24 lg:py-32">
        <div className="lg:w-[25%] flex flex-col text-center md:text-start gap-4">
          <h1 className="text-2xl md:text-[32px] mx-auto lg:mx-0 leading-normal lg:text-[38px] font-semibold text-darkblue">
