  ...
  return (
    <div className="text-white bg-tintblue relative z-10 select-none">
      <div className="container px-4 lg:px-0 py-4 flex items-center  justify-between">
        ...
        <ul
          className={`flex flex-col md:flex-row gap-4 text-textgrey lg:gap-8 absolute lg:ml-auto lg:mr-12 md:static left-0 top-0 md:left-auto md:top-auto shadow-2xl md:shadow-none h-screen md:h-auto w-1/2 md:w-auto bg-tintblue md:bg-transparent p-5 pt-24 md:p-0 text-2xl md:text-base transition-transform duration-700 ${
            isNavOpen
