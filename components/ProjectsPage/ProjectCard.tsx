...
const ProjectCard: React.FC<ProjectCardProps> = ({ data, isProjectPage }) => {
  return (
    <div className={`flex flex-col gap-8 w-full`}>
      ...
      <div className="flex flex-col gap-4">
        <p
          className={`text-darkblue text-sm md:text-base opacity-70 font-medium ${
        ...
        <p
          className={`text-darkblue opacity-70 text-sm md:text-base md:leading-7`}
        >
